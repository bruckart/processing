...
class Mask
{
  ...
  Mask(int x, int y)
  {
    ...
    m_top    = m_center.copy().add(new PVector(0, -70));
    m_bottom = m_center.copy().add(new PVector(0, 75));

    m_upperRight = m_center.copy().add(new PVector(65, -35));
    m_upperLeft  = m_center.copy().add(new PVector(-65, -35));
